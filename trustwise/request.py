...
def evaluate(user_id: str, scan_id: str, query: str, response: PydanticResponse, api_key: Optional[str] = None,
    ...
    data = UploadData(user_id=user_id, scan_id=scan_id, project_id=project_id, query=query, context=context,
